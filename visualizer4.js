function main(){
    ...
    class Bar {
        ...
        draw(context, volume){
            ...
            context.scale(2 + volume * 0.9, 1 + volume * 0.2);

            context.beginPath()
            context.moveTo(this.x, this.y);
            context.lineTo(this.y, this.x);
            context.bezierCurveTo(0, 500, this.height, this.height, this.x, this.y);
            context.stroke();
